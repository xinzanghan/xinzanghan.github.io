...
// 对象实例
const person1 = new Person('心脏涵~')
console.log(person1) // Person {name: '心脏涵~'}
```
...
console.log(person1.name, person2.name) // '心脏涵~' '心脏涵~'
```
